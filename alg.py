...
if __name__ == "__main__":
    # 1. Setup some sample plant data
    sample_plants = [
        {"id": 1, "name": "Snake Plant", "light": "low", "humidity": "low", "care": "easy", "experience": "beginner", "pet_friendly": False},
        {"id": 2, "name": "Monstera", "light": "bright", "humidity": "high", "care": "medium", "experience": "intermediate", "pet_friendly": False},
        {"id": 3, "name": "Spider Plant", "light": "medium", "humidity": "medium", "care": "easy", "experience": "beginner", "pet_friendly": True}
    ]

    # 2. Setup user preferences
    my_current_preferences = {
        "light": "medium",
        "humidity": "medium",
        "care": "easy",
        "experience": "beginner",
    ...
    # 3. Call the function
    top_recommendations = recommend_plants(
        plants=sample_plants,
        current_preferences=my_current_preferences,
        top_n=3
    )

    # 4. Print the results
    print("Top Plant Recommendations:")
    for plant in top_recommendations:
        print(f"- {plant['name']} (Score: {plant['score']})")
